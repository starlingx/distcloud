...
# Orchestrator sleep time
ORCHESTRATION_SLEEP_TIME_IN_SECONDS = 10
ORCHESTRATION_DELETE_COUNTER = 18
...
DEPLOY_STATE_ONSITE_RESTORING = "onsite-restoring"
...
# Subcloud backup delete states
BACKUP_STATE_DELETING_BACKUP = "deleting-backup"
BACKUP_STATE_DELETE_FAILED = "delete-failed"
...
TRANSITORY_STATES = {
    DEPLOY_STATE_NONE: DEPLOY_STATE_CREATE_FAILED,
    DEPLOY_STATE_CREATING: DEPLOY_STATE_CREATE_FAILED,
    DEPLOY_STATE_PRE_INSTALL: DEPLOY_STATE_PRE_INSTALL_FAILED,
    DEPLOY_STATE_INSTALLING: DEPLOY_STATE_INSTALL_FAILED,
    DEPLOY_STATE_PRE_BOOTSTRAP: DEPLOY_STATE_PRE_BOOTSTRAP_FAILED,
    DEPLOY_STATE_BOOTSTRAPPING: DEPLOY_STATE_BOOTSTRAP_FAILED,
    DEPLOY_STATE_PRE_CONFIG: DEPLOY_STATE_PRE_CONFIG_FAILED,
    DEPLOY_STATE_CONFIGURING: DEPLOY_STATE_CONFIG_FAILED,
    DEPLOY_STATE_ABORTING_INSTALL: DEPLOY_STATE_INSTALL_FAILED,
    DEPLOY_STATE_ABORTING_BOOTSTRAP: DEPLOY_STATE_BOOTSTRAP_FAILED,
    DEPLOY_STATE_ABORTING_CONFIG: DEPLOY_STATE_CONFIG_FAILED,
    DEPLOY_STATE_PRE_RESTORE: DEPLOY_STATE_RESTORE_PREP_FAILED,
    DEPLOY_STATE_RESTORING: DEPLOY_STATE_RESTORE_FAILED,
    DEPLOY_STATE_ONSITE_RESTORING: DEPLOY_STATE_RESTORE_FAILED,
    DEPLOY_STATE_PRE_REHOME: DEPLOY_STATE_REHOME_PREP_FAILED,
    DEPLOY_STATE_REHOMING: DEPLOY_STATE_REHOME_FAILED,
    # The next two states are needed due to upgrade scenario:
    # TODO(gherzman): remove states when they are no longer needed
    DEPLOY_STATE_PRE_DEPLOY: DEPLOY_STATE_PRE_CONFIG_FAILED,
    DEPLOY_STATE_DEPLOYING: DEPLOY_STATE_CONFIG_FAILED,
    DEPLOY_STATE_PRE_ENROLL: DEPLOY_STATE_PRE_ENROLL_FAILED,
    DEPLOY_STATE_ENROLLING: DEPLOY_STATE_ENROLL_FAILED,
    DEPLOY_STATE_PRE_INIT_ENROLL: DEPLOY_STATE_PRE_INIT_ENROLL_FAILED,
    DEPLOY_STATE_INITIATING_ENROLL: DEPLOY_STATE_INIT_ENROLL_FAILED,
    DEPLOY_STATE_RECONFIGURING_NETWORK: DEPLOY_STATE_RECONFIGURING_NETWORK_FAILED,
}

TRANSITORY_BACKUP_STATES = {
    BACKUP_STATE_VALIDATING: BACKUP_STATE_VALIDATE_FAILED,
    BACKUP_STATE_PRE_BACKUP: BACKUP_STATE_PREP_FAILED,
    BACKUP_STATE_IN_PROGRESS: BACKUP_STATE_FAILED,
    BACKUP_STATE_DELETING_BACKUP: BACKUP_STATE_DELETE_FAILED,
}

TRANSITORY_PRESTAGE_STATES = {
    PRESTAGE_STATE_PRESTAGING: PRESTAGE_STATE_FAILED,
}
